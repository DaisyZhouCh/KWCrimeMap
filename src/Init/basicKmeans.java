...
/**
 * Created by chongyizhou on 2016-11-19.
 */
public class basicKmeans {

    public double[][] getResult(HashMap<String, Integer> crimeAmount) {
        HashMap<String, String> result = new HashMap<String, String>();
        Set<String> regions = crimeAmount.keySet();
        ArrayList<Double> dataset = new ArrayList<Double>();
        for(String region : regions) {
            int amount = (int)(crimeAmount.get(region));
            dataset.add((double)amount);
        }
        ...
        int k = 5;
        double[][] g;
        g = cluster(datasetArray, k);
        // each row of g represents a cluster, and each column represents a sum of a adminRegion
        return g;
